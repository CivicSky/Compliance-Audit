    ...
    return (
        <div className="px-6 pb-6 pt-6 w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                <div className="bg-white rounded-2xl p-5 w-full border border-slate-200 shadow-sm hover:shadow-lg transform transition-transform hover:-translate-y-1">
                ...
                <div className="bg-white shadow-md rounded-2xl p-5 w-full hover:shadow-lg transition border-2 border-slate-400">
                    <div className="flex justify-between items-start">
